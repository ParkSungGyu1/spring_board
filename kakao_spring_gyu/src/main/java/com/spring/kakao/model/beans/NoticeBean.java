...
public class NoticeBean {
	...
	public int getNoticeTotalCoint() {
		return noticeTotalCoint;
	}
	public void setNoticeTotalCoint(int noticeTotalCoint) {
		this.noticeTotalCoint = noticeTotalCoint;
	}
	...
	public void setTotalPage() {
		this.totalPage = this.noticeTotalCoint%20 == 0 ? this.noticeTotalCoint/20 : noticeTotalCoint / 20 + 1;
	}
	...
	public String toString() {
		return "NoticeBean [noticeTotalCoint=" + noticeTotalCoint + ", pageNumber=" + pageNumber + ", startIndex="
